/****************************************************************************
** Meta object code from reading C++ file 'OCRThread.hpp'
**
...
#error "The header file 'OCRThread.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 8), // "sentInfo"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10) // "getPicPath"

    },
    "OCRThread\0sentInfo\0\0getPicPath"
};
...
void OCRThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sentInfo((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (OCRThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OCRThread::sentInfo)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OCRThread::sentInfo(QString _t1)
{
